...
weighted_country_url = 'https://raw.githubusercontent.com/LucasMichaud2/streamlit_test.py/main/weighted_country.csv'
...
df_nivohm = df_nivohm.drop(columns=['channel', 'formats', selected_objective])
id_hm = 6
