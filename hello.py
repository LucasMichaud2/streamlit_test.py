...
st.markdown(
  f"""
  <div style='display: flex;'>
      <div style='background-color:{df.at[0, 'mapped_colors']}; width: 100px; height: 50px; margin-riht: 10px; font-size:{'10px'}; display: flex; align-items: {'center}; justify-content: {'center};'>{df.at[0, 'Formats']}</div>
